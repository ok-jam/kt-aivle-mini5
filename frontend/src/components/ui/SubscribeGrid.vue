<template>
    <v-container>
        ...
        <div class="panel">
            ...
            <SubscribeView @search="search" style="margin-bottom: 10px; background-color: #ffffff;"></SubscribeView>
            ...
            >
                <v-card>
                    <v-toolbar
                        ...
                        height="50px"
                    >
                        <div style="color:white; font-size:17px; font-weight:700;">Subscribe 등록</div>
                        <v-spacer></v-spacer>
                        <v-icon
                            color="white"
                            small
            ...
            >
                <v-card>
                    <v-toolbar
                        ...
                        height="50px"
                    >
                        <div style="color:white; font-size:17px; font-weight:700;">Subscribe 수정</div>
                        <v-spacer></v-spacer>
                        <v-icon
                            color="white"
                            small
                    ...
                    <v-card-text>
                        <div>
                            ...
                            <Number label="SubcriberId" v-model="selectedRow.subcriberId" :editMode="true"/>
                            <Number label="BookId" v-model="selectedRow.bookId" :editMode="true"/>
                            <구독자Id offline label="구독자 ID" v-model="selectedRow.구독자Id" :editMode="true"/>
