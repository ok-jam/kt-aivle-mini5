                ...
                <v-table>
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td class="whitespace-nowrap" label="PermitSaveAt">{{ val.permitSaveAt }}</td>
                            <td class="whitespace-nowrap" label="ImageUrl">{{ val.imageUrl }}</td>
                            <td class="whitespace-nowrap" label="Category">{{ val.category }}</td>
                            <td class="whitespace-nowrap" label="SubscriberBill">{{ val.subscriberBill }}</td>
                ...
                <v-card>
                    ...
                    <v-card-text>
                        <div>
                            ...
                            <Date label="PermitSaveAt" v-model="selectedRow.permitSaveAt" :editMode="true"/>
                            ...
                            <Number label="SubscriberBill" v-model="selectedRow.subscriberBill" :editMode="true"/>
